# cs7280: B-Tree Indexing Structure Implementation in Go
# Group 7
Member: Jianhua Xue and Zihan Zheng
Index Name: B-tree
Source of selected index: Introduction to Algorithms, Third Edition, by Cormen, Leiserson, Rivest and Stein, from MIT Press (https://mitpress.mit.edu/books/introduction-algorithms), Chapter 18
Input: Manual
Assumptions:
